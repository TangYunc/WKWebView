...
-(UIBarButtonItem*)customBackBarItem{
    if (!_customBackBarItem) {
        ...
        [backButton setImage:[UIImage imageNamed:@"backBtnIcon"] forState:UIControlStateNormal];
        [backButton setImage:[UIImage imageNamed:@"backBtnIcon"] forState:UIControlStateHighlighted];
